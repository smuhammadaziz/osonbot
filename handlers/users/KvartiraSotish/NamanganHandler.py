...
async def first(callback_query: types.CallbackQuery):
    ...
    await NamanganHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=NamanganHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=NamanganHomeSotish.images, content_types=types.ContentTypes.PHOTO)
