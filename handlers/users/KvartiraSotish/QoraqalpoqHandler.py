...
async def first(callback_query: types.CallbackQuery):
    ...
    await QoraqalpoqHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=QoraqalpoqHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=QoraqalpoqHomeSotish.images, content_types=types.ContentTypes.PHOTO)
