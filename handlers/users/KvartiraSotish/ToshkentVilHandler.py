...
async def first(callback_query: types.CallbackQuery):
    ...
    await ToshkentVilHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=ToshkentVilHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=ToshkentVilHomeSotish.images, content_types=types.ContentTypes.PHOTO)
