...
async def first(callback_query: types.CallbackQuery):
    ...
    await JizzaxHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=JizzaxHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=JizzaxHomeSotish.images, content_types=types.ContentTypes.PHOTO)
