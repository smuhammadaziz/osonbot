...
async def first(callback_query: types.CallbackQuery):
    ...
    await NavoiyHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=NavoiyHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=NavoiyHomeSotish.images, content_types=types.ContentTypes.PHOTO)
