...
async def first(callback_query: types.CallbackQuery):
    ...
    await FargonaHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=FargonaHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=FargonaHomeSotish.images, content_types=types.ContentTypes.PHOTO)
