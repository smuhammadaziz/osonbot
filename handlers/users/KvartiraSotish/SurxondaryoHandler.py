...
async def first(callback_query: types.CallbackQuery):
    ...
    await SurxonHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=SurxonHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=SurxonHomeSotish.images, content_types=types.ContentTypes.PHOTO)
