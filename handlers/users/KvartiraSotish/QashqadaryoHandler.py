...
async def first(callback_query: types.CallbackQuery):
    ...
    await QashqadaryoHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=QashqadaryoHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=QashqadaryoHomeSotish.images, content_types=types.ContentTypes.PHOTO)
