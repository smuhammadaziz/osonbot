...
async def first(callback_query: types.CallbackQuery):
    ...
    await XorazmHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=XorazmHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=XorazmHomeSotish.images, content_types=types.ContentTypes.PHOTO)
