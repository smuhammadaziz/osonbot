...
async def first(callback_query: types.CallbackQuery):
    ...
    await SamarqandHomeSotish.umumiyMaydon.set()
...
@dp.message_handler(is_media_group=True, state=SamarqandHomeSotish.images, content_types=types.ContentTypes.PHOTO)
