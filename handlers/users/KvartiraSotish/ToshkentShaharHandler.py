...
async def first(callback_query: types.CallbackQuery):
    ...
    await ToshkentshHomeSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=ToshkentshHomeSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=ToshkentshHomeSotish.images, content_types=types.ContentTypes.PHOTO)
