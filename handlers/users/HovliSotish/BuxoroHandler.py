...
async def first(callback_query: types.CallbackQuery):
    ...
    await BuxoroHomeSotishHovli.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=BuxoroHomeSotishHovli.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=BuxoroHomeSotishHovli.images, content_types=types.ContentTypes.PHOTO)
