...
async def first(callback_query: types.CallbackQuery):
    ...
    await JizzaxYerSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=JizzaxYerSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=JizzaxYerSotish.images, content_types=types.ContentTypes.PHOTO)
