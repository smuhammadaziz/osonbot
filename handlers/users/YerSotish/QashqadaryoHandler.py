...
async def first(callback_query: types.CallbackQuery):
    ...
    await QashqadaryoYerSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=QashqadaryoYerSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=QashqadaryoYerSotish.images, content_types=types.ContentTypes.PHOTO)
