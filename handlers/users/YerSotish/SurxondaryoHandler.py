...
async def first(callback_query: types.CallbackQuery):
    ...
    await SurxondaryoYerSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=SurxondaryoYerSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=SurxondaryoYerSotish.images, content_types=types.ContentTypes.PHOTO)
...
async def check(message: types.Message, state: FSMContext):
    ...
    if mycheck == "✅ Эълонни жойлаш":
        ...
        if data['qoshimchaMalumot'] == "⏭️ Кейингиси" and data['telNumberTwo'] == "⏭️ Кейингиси":
            data1 = "#Сурхондарё      #Вилояти \n"
            data2 = "#Ер_Участка     #Сотилади \n\n"
            data3 = "♦️ Умумий майдон: " + data['umumiyMaydon'] + "-сотих" + "\n"
            data9 = "♦️ "
            gaz = data['gaz']
            svet = data['svet']
