...
async def first(callback_query: types.CallbackQuery):
    await callback_query.answer("hovli BOSILDI")
    await callback_query.message.answer("<b> Умумий майдонини ёзинг </b>", parse_mode="HTML")
    await QoraqalpoqYerSotish.umumiyMaydon.set()


@dp.message_handler(lambda message: not message.text.isdigit(), state=QoraqalpoqYerSotish.umumiyMaydon)
...
@dp.message_handler(is_media_group=True, state=QoraqalpoqYerSotish.images, content_types=types.ContentTypes.PHOTO)
